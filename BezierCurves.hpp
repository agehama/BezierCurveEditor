...
Optional<double> selfIntersection(double x1, double x2, double x3, double x4, double y1, double y2, double y3, double y4)
{
	...
	*/
	...
	const double s = (2 * x2*x2*y1*y1 - 7 * x2*x3*y1*y1 +
		6 * x3*x3*y1*y1 + 3 * x2*x4*y1*y1 -
		5 * x3*x4*y1*y1 + x4*x4*y1*y1 - 4 * x1*x2*y1*y2 +
		7 * x1*x3*y1*y2 + 9 * x2*x3*y1*y2 - 15 * x3*x3*y1*y2 -
		3 * x1*x4*y1*y2 - 5 * x2*x4*y1*y2 + 14 * x3*x4*y1*y2 -
		3 * x4*x4*y1*y2 + 2 * x1*x1*y2*y2 -
		9 * x1*x3*y2*y2 + 9 * x3*x3*y2*y2 +
		5 * x1*x4*y2*y2 - 9 * x3*x4*y2*y2 +
		2 * x4*x4*y2*y2 + 7 * x1*x2*y1*y3 - 9 * x2*x2*y1*y3 -
		12 * x1*x3*y1*y3 + 15 * x2*x3*y1*y3 + 5 * x1*x4*y1*y3 - 4 * x2*x4*y1*y3 -
		3 * x3*x4*y1*y3 + x4*x4*y1*y3 - 7 * x1*x1*y2*y3 +
		9 * x1*x2*y2*y3 + 15 * x1*x3*y2*y3 - 18 * x2*x3*y2*y3 -
		10 * x1*x4*y2*y3 + 9 * x2*x4*y2*y3 + 3 * x3*x4*y2*y3 -
		x4*x4*y2*y3 + 6 * x1*x1*y3*y3 -
		15 * x1*x2*y3*y3 + 9 * x2*x2*y3*y3 +
		3 * x1*x4*y3*y3 - 3 * x2*x4*y3*y3 - 3 * x1*x2*y1*y4 +
		5 * x2*x2*y1*y4 + 5 * x1*x3*y1*y4 - 10 * x2*x3*y1*y4 +
		3 * x3*x3*y1*y4 - 2 * x1*x4*y1*y4 + 3 * x2*x4*y1*y4 -
		x3*x4*y1*y4 + 3 * x1*x1*y2*y4 - 5 * x1*x2*y2*y4 -
		4 * x1*x3*y2*y4 + 9 * x2*x3*y2*y4 - 3 * x3*x3*y2*y4 +
		3 * x1*x4*y2*y4 - 4 * x2*x4*y2*y4 + x3*x4*y2*y4 -
		5 * x1*x1*y3*y4 + 14 * x1*x2*y3*y4 - 9 * x2*x2*y3*y4 -
		3 * x1*x3*y3*y4 + 3 * x2*x3*y3*y4 - x1*x4*y3*y4 + x2*x4*y3*y4 +
		x1*x1*y4*y4 - 3 * x1*x2*y4*y4 +
		2 * x2*x2*y4*y4 + x1*x3*y4*y4 -
		x2*x3*y4*y4 -
		Sqrt(Power(-2 * x2*x2*y1*y1 + 7 * x2*x3*y1*y1 -
			6 * x3*x3*y1*y1 - 3 * x2*x4*y1*y1 +
			5 * x3*x4*y1*y1 - x4*x4*y1*y1 +
			4 * x1*x2*y1*y2 - 7 * x1*x3*y1*y2 - 9 * x2*x3*y1*y2 +
			15 * x3*x3*y1*y2 + 3 * x1*x4*y1*y2 + 5 * x2*x4*y1*y2 -
			14 * x3*x4*y1*y2 + 3 * x4*x4*y1*y2 -
			2 * x1*x1*y2*y2 + 9 * x1*x3*y2*y2 -
			9 * x3*x3*y2*y2 - 5 * x1*x4*y2*y2 +
			9 * x3*x4*y2*y2 - 2 * x4*x4*y2*y2 -
			7 * x1*x2*y1*y3 + 9 * x2*x2*y1*y3 + 12 * x1*x3*y1*y3 -
			15 * x2*x3*y1*y3 - 5 * x1*x4*y1*y3 + 4 * x2*x4*y1*y3 +
			3 * x3*x4*y1*y3 - x4*x4*y1*y3 + 7 * x1*x1*y2*y3 -
			9 * x1*x2*y2*y3 - 15 * x1*x3*y2*y3 + 18 * x2*x3*y2*y3 +
			10 * x1*x4*y2*y3 - 9 * x2*x4*y2*y3 - 3 * x3*x4*y2*y3 +
			x4*x4*y2*y3 - 6 * x1*x1*y3*y3 +
			...
			2 * x2*x2*y4*y4 - x1*x3*y4*y4 +
			x2*x3*y4*y4, 2) -
			4 * (x2*x2*y1*y1 - 3 * x2*x3*y1*y1 +
				3 * x3*x3*y1*y1 + x2*x4*y1*y1 -
				3 * x3*x4*y1*y1 + x4*x4*y1*y1 -
				2 * x1*x2*y1*y2 + 3 * x1*x3*y1*y2 - 3 * x3*x3*y1*y2 -
				x1*x4*y1*y2 + 2 * x2*x4*y1*y2 + 3 * x3*x4*y1*y2 -
				2 * x4*x4*y1*y2 + x1*x1*y2*y2 -
				2 * x1*x4*y2*y2 + x4*x4*y2*y2 +
				3 * x1*x2*y1*y3 - 6 * x1*x3*y1*y3 + 3 * x2*x3*y1*y3 +
				3 * x1*x4*y1*y3 - 6 * x2*x4*y1*y3 + 3 * x3*x4*y1*y3 -
				3 * x1*x1*y2*y3 + 3 * x1*x3*y2*y3 + 3 * x1*x4*y2*y3 -
				3 * x3*x4*y2*y3 + 3 * x1*x1*y3*y3 -
				3 * x1*x2*y3*y3 - 3 * x1*x4*y3*y3 +
				3 * x2*x4*y3*y3 - x1*x2*y1*y4 - 2 * x2*x2*y1*y4 +
				3 * x1*x3*y1*y4 + 3 * x2*x3*y1*y4 - 3 * x3*x3*y1*y4 -
				2 * x1*x4*y1*y4 + 2 * x2*x4*y1*y4 + x1*x1*y2*y4 +
				2 * x1*x2*y2*y4 - 6 * x1*x3*y2*y4 + 3 * x3*x3*y2*y4 +
				2 * x1*x4*y2*y4 - 2 * x2*x4*y2*y4 - 3 * x1*x1*y3*y4 +
				3 * x1*x2*y3*y4 + 3 * x1*x3*y3*y4 - 3 * x2*x3*y3*y4 +
				x1*x1*y4*y4 - 2 * x1*x2*y4*y4 +
				x2*x2*y4*y4)*
				(x2*x2*y1*y1 - 4 * x2*x3*y1*y1 +
					4 * x3*x3*y1*y1 + 2 * x2*x4*y1*y1 -
					4 * x3*x4*y1*y1 + x4*x4*y1*y1 -
					2 * x1*x2*y1*y2 + 4 * x1*x3*y1*y2 + 6 * x2*x3*y1*y2 -
					12 * x3*x3*y1*y2 - 2 * x1*x4*y1*y2 - 4 * x2*x4*y1*y2 +
					14 * x3*x4*y1*y2 - 4 * x4*x4*y1*y2 +
					x1*x1*y2*y2 - 6 * x1*x3*y2*y2 +
					9 * x3*x3*y2*y2 + 4 * x1*x4*y2*y2 -
					12 * x3*x4*y2*y2 + 4 * x4*x4*y2*y2 +
					4 * x1*x2*y1*y3 - 6 * x2*x2*y1*y3 - 8 * x1*x3*y1*y3 +
					12 * x2*x3*y1*y3 + 4 * x1*x4*y1*y3 - 4 * x2*x4*y1*y3 -
					4 * x3*x4*y1*y3 + 2 * x4*x4*y1*y3 - 4 * x1*x1*y2*y3 +
					6 * x1*x2*y2*y3 + 12 * x1*x3*y2*y3 - 18 * x2*x3*y2*y3 -
					10 * x1*x4*y2*y3 + 12 * x2*x4*y2*y3 + 6 * x3*x4*y2*y3 -
					4 * x4*x4*y2*y3 + 4 * x1*x1*y3*y3 -
					12 * x1*x2*y3*y3 + 9 * x2*x2*y3*y3 +
					4 * x1*x4*y3*y3 - 6 * x2*x4*y3*y3 +
					x4*x4*y3*y3 - 2 * x1*x2*y1*y4 +
					4 * x2*x2*y1*y4 + 4 * x1*x3*y1*y4 - 10 * x2*x3*y1*y4 +
					4 * x3*x3*y1*y4 - 2 * x1*x4*y1*y4 + 4 * x2*x4*y1*y4 -
					2 * x3*x4*y1*y4 + 2 * x1*x1*y2*y4 - 4 * x1*x2*y2*y4 -
					4 * x1*x3*y2*y4 + 12 * x2*x3*y2*y4 - 6 * x3*x3*y2*y4 +
					4 * x1*x4*y2*y4 - 8 * x2*x4*y2*y4 + 4 * x3*x4*y2*y4 -
					4 * x1*x1*y3*y4 + 14 * x1*x2*y3*y4 -
					12 * x2*x2*y3*y4 - 4 * x1*x3*y3*y4 + 6 * x2*x3*y3*y4 -
					2 * x1*x4*y3*y4 + 4 * x2*x4*y3*y4 - 2 * x3*x4*y3*y4 +
					x1*x1*y4*y4 - 4 * x1*x2*y4*y4 +
					4 * x2*x2*y4*y4 + 2 * x1*x3*y4*y4 -
					4 * x2*x3*y4*y4 + x3*x3*y4*y4))) /
					(2.*(x2*x2*y1*y1 - 4 * x2*x3*y1*y1 +
						4 * x3*x3*y1*y1 + 2 * x2*x4*y1*y1 -
						4 * x3*x4*y1*y1 + x4*x4*y1*y1 - 2 * x1*x2*y1*y2 +
						4 * x1*x3*y1*y2 + 6 * x2*x3*y1*y2 - 12 * x3*x3*y1*y2 -
						2 * x1*x4*y1*y2 - 4 * x2*x4*y1*y2 + 14 * x3*x4*y1*y2 -
						4 * x4*x4*y1*y2 + x1*x1*y2*y2 -
						6 * x1*x3*y2*y2 + 9 * x3*x3*y2*y2 +
						4 * x1*x4*y2*y2 - 12 * x3*x4*y2*y2 +
						4 * x4*x4*y2*y2 + 4 * x1*x2*y1*y3 -
						6 * x2*x2*y1*y3 - 8 * x1*x3*y1*y3 + 12 * x2*x3*y1*y3 +
						4 * x1*x4*y1*y3 - 4 * x2*x4*y1*y3 - 4 * x3*x4*y1*y3 +
						2 * x4*x4*y1*y3 - 4 * x1*x1*y2*y3 + 6 * x1*x2*y2*y3 +
						12 * x1*x3*y2*y3 - 18 * x2*x3*y2*y3 - 10 * x1*x4*y2*y3 +
						12 * x2*x4*y2*y3 + 6 * x3*x4*y2*y3 - 4 * x4*x4*y2*y3 +
						4 * x1*x1*y3*y3 - 12 * x1*x2*y3*y3 +
						9 * x2*x2*y3*y3 + 4 * x1*x4*y3*y3 -
						6 * x2*x4*y3*y3 + x4*x4*y3*y3 - 2 * x1*x2*y1*y4 +
						4 * x2*x2*y1*y4 + 4 * x1*x3*y1*y4 - 10 * x2*x3*y1*y4 +
						4 * x3*x3*y1*y4 - 2 * x1*x4*y1*y4 + 4 * x2*x4*y1*y4 -
						2 * x3*x4*y1*y4 + 2 * x1*x1*y2*y4 - 4 * x1*x2*y2*y4 -
						4 * x1*x3*y2*y4 + 12 * x2*x3*y2*y4 - 6 * x3*x3*y2*y4 +
						4 * x1*x4*y2*y4 - 8 * x2*x4*y2*y4 + 4 * x3*x4*y2*y4 -
						4 * x1*x1*y3*y4 + 14 * x1*x2*y3*y4 - 12 * x2*x2*y3*y4 -
						4 * x1*x3*y3*y4 + 6 * x2*x3*y3*y4 - 2 * x1*x4*y3*y4 + 4 * x2*x4*y3*y4 -
						2 * x3*x4*y3*y4 + x1*x1*y4*y4 - 4 * x1*x2*y4*y4 +
						4 * x2*x2*y4*y4 + 2 * x1*x3*y4*y4 -
						4 * x2*x3*y4*y4 + x3*x3*y4*y4));

	const double t =
		(3 * s*x2*y1 - 2 * s*s*x2*y1 + 3 * x3*y1 - 6 * s*x3*y1 +
			4 * s*s*x3*y1 - 3 * x4*y1 + 3 * s*x4*y1 - 2 * s*s*x4*y1 -
			3 * s*x1*y2 + 2 * s*s*x1*y2 - 3 * x3*y2 + 9 * s*x3*y2 -
			6 * s*s*x3*y2 + 3 * x4*y2 - 6 * s*x4*y2 + 4 * s*s*x4*y2 -
			3 * x1*y3 + 6 * s*x1*y3 - 4 * s*s*x1*y3 + 3 * x2*y3 - 9 * s*x2*y3 +
			6 * s*s*x2*y3 + 3 * s*x4*y3 - 2 * s*s*x4*y3 + 3 * x1*y4 -
			3 * s*x1*y4 + 2 * s*s*x1*y4 - 3 * x2*y4 + 6 * s*x2*y4 -
			4 * s*s*x2*y4 - 3 * s*x3*y4 + 2 * s*s*x3*y4) /
			(x2*y1 - x4*y1 - x1*y2 - 3 * x3*y2 + 4 * x4*y2 + 3 * x2*y3 - 3 * x4*y3 +
				x1*y4 - 4 * x2*y4 + 3 * x3*y4);
